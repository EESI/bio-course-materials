...
singularity exec --bind /ifs/groups/eces450650Grp/bio-course-materials/qiime2_tutorial:/qiime2_tutorial ../../containers/qiime bash /qiime2_tutorial/qiime_tutorial.sh
